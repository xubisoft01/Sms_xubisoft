...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="{% url 'admin:index' %}">
      ...
      <span class="ms-1 font-weight-bold">SMS Dashboard</span>
    </a>
  </div>
    ...
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      ...
      <div class="card-body text-start p-3 w-100">
        ...
        <div class="docs-info">
          ...
          <a href="http://xubisoft.com" 
             target="_blank" class="btn btn-white btn-sm w-100 mb-0"> Read More </a>
        </div>
      </div>
    </div>
    <a target="_blank"
       class="btn bg-gradient-primary mt-3 w-100" 
       href="http://xubisoft.com">Support Team</a>
  </div>
</aside>